      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10 flex flex-col md:flex-row justify-between items-center gap-6">
        ...
        <div className="flex items-center gap-4">
          ...
          <p className="font-body text-slate-500 text-sm">
            ...
            <br />
            <a href="https://github.com/Christ2007/SpeedDrone" target="_blank" rel="noopener noreferrer" className="text-primary hover:text-red-400 transition-colors flex items-center gap-2 mt-2 w-fit">
